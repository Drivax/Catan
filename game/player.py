...
class Player:
    ...
    def can_build_city(self):
        ...
        # FIX: on ne peut upgrader que si on a une colonie sur le plateau
    ...
    def build_road(self, free_cost=False):
        ...
        if free_cost or self.can_build_road():
            ...
            # POINTS_DIC["road"] == 0, pas de points pour une route
    ...
    def build_city(self):
        ...
        FIX: une ville remplace une colonie.

        - On retire 1 colonie (settlements_built--, settlements_left++)

        - On ajoute 1 ville

        - Gain net de points : POINTS_DIC["city"] - POINTS_DIC["colony"] = 2 - 1 = +1
        ...
        # Gain net de points (+1 car la colonie valait deja 1 pt)

        self.victory_points += POINTS_DIC["city"] - POINTS_DIC["colony"]
    ...
    def discard_half(self):
        ...
        for res, amt in list(self.resources.items()):
