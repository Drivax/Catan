...
def compare_agents(agent_template, num_games=100, max_turns=500):
    ...
    # Create descriptive labels for each agent
    agent_labels = []
    for agent in agent_template:
    ...
    create_charts(agent_wins, agent_labels, num_games)
...
def create_charts(agent_wins, agent_labels, num_games):
    ...
    print("\n[SUCCESS] Chart saved as 'agent_comparison.png'")
    plt.show()
